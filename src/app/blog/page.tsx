      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">
            <span className="text-gradient-gold">Fragrance</span> Journal
          </h1>
          <p className="text-gray-300 max-w-3xl mx-auto">
            Explore the world of perfumery through our expert guides, tips, and insights
          </p>
        </div>
        
        {/* Featured Article */}
        <div className="mb-16">
          <div className="bg-blck-card rounded-xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <span className="text-blck-gold text-sm font-medium mb-2">FEATURED ARTICLE</span>
                ...
                <Link href="/blog/the-art-of-perfumery">
                  <Button className="bg-blck-accent hover:bg-blck-accent/80 text-white w-full md:w-auto">
                    Read Article
                  </Button>
                </Link>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {faqs.map((article) => (
            <div key={article.id} className="bg-blck-card rounded-lg overflow-hidden hover:shadow-lg hover:shadow-blck-accent/20 transition-all duration-300 flex flex-col h-full">
              ...
              <div className="p-6 flex-grow">
                <span className="text-gray-400 text-sm mb-2 block">{article.date}</span>
                <h3 className="text-xl font-medium mb-3 text-blck-silver">{article.title}</h3>
                <p className="text-gray-400 mb-4">{article.excerpt}</p>
              </div>
              <div className="px-6 pb-6">
                <Link href={`/blog/${article.id}`}>
                  <Button className="w-full bg-transparent border border-blck-accent text-blck-accent hover:bg-blck-accent hover:text-white transition-colors">
                    Read More
                  </Button>
                </Link>
              </div>
        ...
        <div className="bg-blck-card rounded-xl p-10 text-center">
          <h2 className="text-2xl font-serif font-bold mb-4 text-blck-gold">Subscribe to Our Newsletter</h2>
          ...
          <form className="max-w-md mx-auto">
            <div className="flex flex-row items-stretch">
              <input 
                ...
                className="bg-blck-purple text-white px-4 py-2 rounded-l-md flex-grow focus:outline-none focus:ring-1 focus:ring-blck-gold"
              />
              <button 
                type="submit" 
                className="bg-blck-gold text-white px-6 py-2 rounded-r-md hover:bg-opacity-90 transition-colors whitespace-nowrap"
              >
                Subscribe
              </button>
            </div>
